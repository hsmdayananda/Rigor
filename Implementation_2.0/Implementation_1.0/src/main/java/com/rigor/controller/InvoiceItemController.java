...
public class InvoiceItemController {
	...
	public ModelAndView addInvoice(InvoiceItem invoiceItem, BindingResult result) {
		ModelAndView modelAndView = new ModelAndView("edit-invoice");
	...
	@RequestMapping(value = "/editInvoice.htm",method=RequestMethod.POST)
	public ModelAndView editInvoice(InvoiceItem invoiceItem, BindingResult result) {
		ModelAndView modelAndView = new ModelAndView("edit-invoice");
	...
	@RequestMapping(value = "/editInvoice.htm",method=RequestMethod.GET)
	public ModelAndView editInvoice(ModelMap modelmap) {
		ModelAndView modelAndView = new ModelAndView("edit-invoice");
